...
FROM ghcr.io/open-component-model/ocm/ocm.software/ocmcli/ocmcli-image:0.28.0 AS ocmcli
#############      builder       #############
...
############# tm-controller #############
FROM alpine:3.22 AS tm-controller
